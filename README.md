...
Downloads a word list from the web,

Prompts the user to enter a word,

Finds “rhyming” words by matching the last 2 letters,

Sorts the results using Bubble Sort,

Prints the rhymes in ascending (alphabetical) order.
...
(See implementation in the async/await version.) 

Data_usingAsync_nd_Await
...
Rhyme with last 2 words from 'time': ... 
...
Data_original.js
A similar implementation (also Promise-based in your file) with the same overall behaviour. 
...
The output depends on the online word list availability and connection.
